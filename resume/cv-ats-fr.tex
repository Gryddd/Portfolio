...
\begin{itemize}
  \item Participation aux optimisations serveurs et au monitoring, contribuant à une hausse de 20\% de la disponibilité de l'infrastructure centrale.
  \item Contribution à l'optimisation des opérations courantes et de l'utilisation des ressources, réduisant les coûts d'exploitation de 15\%.
\end{itemize}
